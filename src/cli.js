...
var OPTIONS = {
	...
	"extract": [
		"extract",
		"Extract inline scripts contained in HTML (auto|always|never, default to auto)",
		"string",
		"auto"
	],
	...
	run: function (opts, cb) {
		...
		if (opts.useStdin) {
			cli.withStdin(function (code) {
				code = extractIfNeeded(code, opts.extract);
