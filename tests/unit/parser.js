...
exports["array comprehension as es5"] = function (test) {
  ...
  TestRun(test)
    ...
    .addError(6, "'array comprehension' is only available in ES6 (use 'esversion: 6').")
    .addError(7, "'array comprehension' is only available in ES6 (use 'esversion: 6').")
    .test(code, {unused: true, undef: true, predef: ["print"]}); // es5
...
exports['array comprehension with dest array at global scope as es5'] = function (test) {
  ...
  TestRun(test)
    .addError(1, "'array comprehension' is only available in ES6 (use 'esversion: 6').")
    .addError(2, "'array comprehension' is only available in ES6 (use 'esversion: 6').")
    .addError(3, "'array comprehension' is only available in ES6 (use 'esversion: 6').")
