...
exports.es5 = function (test) {
  ...
  TestRun(test)
    ...
    .addError(15, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(16, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(20, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(22, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(26, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(30, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(31, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(36, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(41, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(42, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(43, "Duplicate key 'x'.")
    .addError(47, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(48, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(48, "Duplicate key 'x'.")
    .addError(52, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(53, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(54, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(54, "Duplicate key 'x'.")
    .addError(58, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(58, "Unexpected parameter 'a' in get x function.")
    .addError(59, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(59, "Unexpected parameter 'a' in get y function.")
    .addError(60, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(62, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(62, "Expected a single parameter in set x function.")
    .addError(63, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(64, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(64, "Expected a single parameter in set z function.")
    .addError(68, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(69, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(68, "Missing property name.")
    .addError(69, "Missing property name.")
    .addError(75, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .addError(76, "'`get` method' is only available in ES5 (use 'esversion: 5').")
    .addError(80, "'`set` method' is only available in ES5 (use 'esversion: 5').")
    .test(src, { es3: true });
